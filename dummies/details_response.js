  ...
  response: {
    venue: {
            ...
            items: [
              {
                ...
                suffix:
                  "/655018_Zp3vA90Sy4IIDApvfAo5KnDItoV0uEDZeST7bWT-qzk.jpg",
                width: 612,
                height: 612,
                user: {
                  id: "123456",
      ...
      page: {
        pageInfo: {
          description:
            "The mission of the Central Park Conservancy, a private non-profit, is to restore, manage, and enhance Central Park, in partnership with the public.",
            ...
            items: [
              {
                ...
                type: "user",
                canonicalUrl:
                  "https://foursquare.com/item/5150464ee4b02f70eb28eee4",
                photo: {
                  ...
                  prefix: "https://igx.4sqi.net/img/general/",
                  suffix:
                    "/13764780_Ao02DfJpgG1ar2PfgP51hOKWsn38iai8bsSpzKd0GcM.jpg",
                  width: 800,
                  height: 542,
                  visibility: "public"
                },
                photourl:
                  "https://igx.4sqi.net/img/general/original/13764780_Ao02DfJpgG1ar2PfgP51hOKWsn38iai8bsSpzKd0GcM.jpg",
                lang: "en",
                likes: {
                  count: 247,
                  groups: [
              ...
              },
              {
                ...
                text:
                  "Lots of squirrels in the park! パーク内にはリスがたくさんいます！しかも思ったよりデカイです。",
                type: "user",
                logView: true,
                editedAt: 1399418942,
                agreeCount: 61,
              ...
              },
              {
                ...
                text:
                  "PHOTO: 1975 was the last year the New York City marathon was raced entirely inside Central Park. In this photo, runners at the marathon starting line.",
                type: "user",
                url:
                  "http://www.nydailynewspix.com/sales/largeview.php?name=87g0km0g.jpg&id=152059&lbx=-1&return_page=searchResults.php&page=2",
                canonicalUrl:
                  "https://foursquare.com/item/4cd5bda1b6962c0fd19c2e96",
                lang: "en",
                likes: {
                  count: 26,
                  groups: [
            ...
            items: [
              {
                ...
                description:
                  "Best spots to see in Manhattan (New York City) as restaurants, monuments and public spaces. Enjoy!",
                type: "others",
                user: {
                  id: "356747",
                  firstName: "John",
                ...
                canonicalUrl:
                  "https://foursquare.com/boke/list/101-places-to-see-in-manhattan-before-you-die",
                  ...
                  items: [
                    {
                      ...
                      photo: {
                        ...
                        prefix: "https://igx.4sqi.net/img/general/",
                        suffix:
                          "/KaAuGPKMZev1Te0uucRYHk92RiULGj3-GYWkX_zXbjM.jpg",
                        width: 720,
                        height: 532,
                        visibility: "public"
                      }
      ...
      phrases: [
        {
          ...
          sample: {
            ...
            text:
              "... a ponta, curtir o parque todo, sem pressa, admirando cada lugar. Se puder..."
          },
          count: 4
        }
      ],
...
// export default details // not working, o ES6 support in json-server
